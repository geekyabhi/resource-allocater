...
class LikeViewSet(viewsets.ModelViewSet):
    ...
    def add_like(self, request):
        try:
            ...
            like_data = self.service.add_like(
                {
            ...
            return Response(
                {"data": like_data, "success": True}, status=status.HTTP_201_CREATED
            )
    ...
    def get_likes(self, request, machine_id):
        try:
            ...
            dislikes = self.service.get_count(
                {"machine_id": machine_id, "status": False}
            )
            return Response(
                {"success": True, "data": {"likes": likes, "dislikes": dislikes}},
